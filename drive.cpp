...
void drive()
{
    ...
    do
    {
        ...
        do{
        cout << "Please enter the three letter airport code you wish to travel from: ";
        cin >> input;
        for(size_t i = 0; i < input.length(); i++)
        {
            input[i] = toupper(input[i]);
        }
        }while(nameToNumber.find(input) == nameToNumber.end());

        int s = nameToNumber[input];

        do{
        cout << "Please enter the three letter airport code you wish to travel to: ";
        cin >> input;
        for(size_t i = 0; i < input.length(); i++)
        {
            input[i] = toupper(input[i]);
